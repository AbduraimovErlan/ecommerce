...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = 'id title price category reviews  all_reviews'.split()
    ...
    def get_reviews(self, product):
        serializers = ReviewSerializer(Review.objects.filter(author__isnull=False, product=product), many=True)
